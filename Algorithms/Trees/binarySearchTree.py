...
Methods - find_element(value), get_min(),successor(value), 
...
class BinarySearchTree(object):
	...
	def get_min(self):
		return _extremes(self.root,find_min=True)

	def successor(self,value):
		""" retrn successor of the element with value = value """
	...
	def delete(self,value):
		""" deletes a node value from the BST """
		node=self.find_element(value)
		if not node:
			return None
